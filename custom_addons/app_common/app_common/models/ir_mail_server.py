...
class IrMailServer(models.Model):
    ...
    def send_email(self, message, mail_server_id=None, smtp_server=None, smtp_port=None,
        ...
        # 忽略掉无效email，避免被ban
        if email_to:
            if email_to.find('no-reply@erp.cn') != -1 or email_to.find('postmaster-erp@erp.cn') != -1:
                pass
            elif email_to.find('example.com') != -1 or email_to.find('@sunpop.cn') != -1 or email_to.find('@erpapp.cn') != -1:
